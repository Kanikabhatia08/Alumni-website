            ...
            <div class="mx-auto w-full max-w-[85%] p-4 py-5 lg:pt-10">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-10 sm:grid-cols-2 font-mons">
                        ...
                        <div>
                            ...
                            <ul class="font-medium">
                                <li class="mb-4">
                                    <a href="https://www.linkedin.com/school/punjabi-university-patiala/" class="hover:underline " target='blank'>LinkedIn</a>
                                </li>
                                <li>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="https://www.linkedin.com/school/punjabi-university-patiala/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <FaLinkedin/>
